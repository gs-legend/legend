import { _, Component, PostConstruct, RefSelector, Autowired, ResizeObserverService } from 'components/Grid/core';
import { MiniChartsContainer } from "./miniChartsContainer";
import { AgChartThemePalette } from "components/Grid/charts";
