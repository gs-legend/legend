...
var jsxShowValue = function (showDetails, key, parentId, cellRendererRef, showTools, reactCellRendererStateless, setECellValue) {
...
var CellComp = function (props) {
    ...
    var _g = react_1.useState(), ariaSelected = _g[0], setAriaSelected = _g[1];
    var _h = react_1.useState(), ariaExpanded = _h[0], setAriaExpanded = _h[1];
    var _j = react_1.useState(), ariaColIndex = _j[0], setAriaColIndex = _j[1];
    var _k = react_1.useState(), ariaDescribedBy = _k[0], setAriaDescribedBy = _k[1];
    var _l = react_1.useState(), role = _l[0], setRole = _l[1];
    var _m = react_1.useState(), colId = _m[0], setColId = _m[1];
    var _o = react_1.useState(), title = _o[0], setTitle = _o[1];
    var _p = react_1.useState(false), includeSelection = _p[0], setIncludeSelection = _p[1];
    var _q = react_1.useState(false), includeRowDrag = _q[0], setIncludeRowDrag = _q[1];
    var _r = react_1.useState(false), includeDndSource = _r[0], setIncludeDndSource = _r[1];
    var _s = react_1.useState(), jsEditorComp = _s[0], setJsEditorComp = _s[1];
    ...
    var _t = react_1.useState(0), cellWrapperVersion = _t[0], setCellWrapperVersion = _t[1];
    ...
    var _u = react_1.useState(0), cellValueVersion = _u[0], setCellValueVersion = _u[1];
    ...
    var showContents = function () { return react_1.default.createElement(react_1.default.Fragment, null,
        renderDetails != null && jsxShowValue(renderDetails, renderKey, cellInstanceId, cellRendererRef, showTools, reactCellRendererStateless, setCellValueRef),
